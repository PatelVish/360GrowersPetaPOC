...
#pragma warning disable 1066,1570,1573,1591
            ...
            try
            {
                ...
                try
                {
                    using (var cmd = CreateCommand(_sharedConnection, ""))
                    {
                        ...
                        //string insertPreamble = string.Empty; // uncomment for option 2 
                        //string insertPostScript = string.Empty; // uncomment for option 2
                        /*Vishal start*/
                        if (autoIncrement)
                        {
                            //insertPreamble = _provider.GetInsertPreamble(primaryKeyName); // uncomment for option 2
                            outputClause = _provider.GetInsertOutputClause(primaryKeyName);
                            //insertPostScript = _provider.GetInsertPostScript(primaryKeyName); // uncomment for option 2
                        }

                        // commented for option 2
    ...
    public interface IProvider
    {
        ...
        /*Vishal Start - uncomment for option 2*/
        ///// <summary>
    ...
    public class SqlServerDatabaseProvider : DatabaseProvider
    {
        ...
        {
            return String.Format(" OUTPUT INSERTED.[{0}]", primaryKeyName); //comment for option 2
            //return String.Format(" OUTPUT INSERTED.[{0}] into @result({0})", primaryKeyName); // uncomment for option 2
        }
